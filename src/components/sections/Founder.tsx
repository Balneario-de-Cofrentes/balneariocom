        ...
        <div className="grid items-center gap-12 lg:grid-cols-5 lg:gap-20">
          ...
          >
            ...
            <p className="mt-3 text-base font-body font-light text-white/50 italic">
              Fundador, Director medico y autor de &quot;Las 10 claves para una Longevidad Saludable&quot;
            </p>
            ...
            <div className="mt-10 relative">
              <blockquote className="border-l-2 border-lime/40 pl-6">
                <p className="font-display text-xl leading-relaxed text-white/80 lg:text-2xl">
                  Este no es un balneario tradicional. Es el resultado de 35 anos de trabajo
                  para crear la clinica de longevidad mas grande de Europa.
                </p>
              </blockquote>
            </div>

            <p className="mt-8 text-[15px] font-body font-light leading-relaxed text-white/50">
              280 habitaciones, Clinica de Longevidad, Circuito Termal, Human Lab,
              Laboratorio, y mas de 300 profesionales incluyendo 12 medicos y 3 ingenieros
              especializados en Inteligencia Artificial. Una apuesta por la tecnologia
              y la longevidad que no existe en ningun otro balneario del mundo.
            </p>

            {/* Stats */}
            <div className="mt-12 grid grid-cols-3 gap-8">
              {[
                { number: "35+", label: "anos operando" },
                { number: "12", label: "medicos en plantilla" },
                { number: "8", label: "proyectos de investigacion" },
              ].map((stat) => (
                <div key={stat.label}>
